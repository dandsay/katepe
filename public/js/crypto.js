 ...
 * Cepat, native di browser, tanpa external heavy library
 */
...
const AppCrypto = {
    ...
    async encrypt(text, key) {
        ...
        // Gabungkan IV dan Ciphertext ke Base64
    ...
    async hashNIK(nik) {
        const enc = new TextEncoder();
        const hashBuffer = await window.crypto.subtle.digest("SHA-256", enc.encode(nik));
